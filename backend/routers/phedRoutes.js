...
router.patch("/alert/:id", authenticate, updateAlertStatus); // Get all alerts for PHED
...
router.get("/asset/:gpid", authenticate, getSingleGpAsset);
...
router.get("/inventory/:gpId", authenticate, getSingleGpInventory); // 
...
router.patch("/fund/requests/:id", authenticate, updateStatusFundRqst); // Get all fund requests for PHED
